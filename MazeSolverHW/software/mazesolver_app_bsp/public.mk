...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../mazesolver_soc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is mazesolver_soc
SOPC_NAME := mazesolver_soc
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2050
SOPC_SYSID_FLAG += --sidp=0x2050
ELF_PATCH_FLAG  += --sidp 0x2050

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1448544260
SOPC_SYSID_FLAG += --timestamp=1448544260
ELF_PATCH_FLAG  += --timestamp 1448544260
