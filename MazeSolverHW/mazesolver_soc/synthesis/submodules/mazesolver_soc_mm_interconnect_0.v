// mazesolver_soc_mm_interconnect_0.v

// This file was auto-generated from altera_mm_interconnect_hw.tcl.  If you edit it your changes
// will probably be lost.
// 
// Generated using ACDS version 14.0 200 at 2015.11.26.07:24:59

`timescale 1 ps / 1 ps
module mazesolver_soc_mm_interconnect_0 (
	...
	wire    [7:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> nios2_qsys_0_instruction_master_agent:rp_channel
	...
	wire    [7:0] rsp_mux_001_src_channel;                                                            // rsp_mux_001:src_channel -> nios2_qsys_0_data_master_agent:rp_channel
	...
	wire    [7:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> nios2_qsys_0_jtag_debug_module_agent:cp_channel
	...
	wire  [104:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> sysid_qsys_0_control_slave_agent:cp_data
	...
	wire  [104:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> sdram_s1_agent:cp_data
	wire    [7:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> sdram_s1_agent:cp_channel
	...
	wire    [7:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> jtag_uart_0_avalon_jtag_slave_agent:cp_channel
	...
	wire   [28:0] key_1_s1_agent_m0_address;                                                          // key_1_s1_agent:m0_address -> key_1_s1_translator:uav_address
	...
	wire  [105:0] key_1_s1_agent_rf_source_data;                                                      // key_1_s1_agent:rf_source_data -> key_1_s1_agent_rsp_fifo:in_data
	...
	wire  [105:0] key_1_s1_agent_rsp_fifo_out_data;                                                   // key_1_s1_agent_rsp_fifo:out_data -> key_1_s1_agent:rf_sink_data
	wire          key_1_s1_agent_rsp_fifo_out_ready;                                                  // key_1_s1_agent:rf_sink_ready -> key_1_s1_agent_rsp_fifo:out_ready
	wire          key_1_s1_agent_rdata_fifo_src_valid;                                                // key_1_s1_agent:rdata_fifo_src_valid -> key_1_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] key_1_s1_agent_rdata_fifo_src_data;                                                 // key_1_s1_agent:rdata_fifo_src_data -> key_1_s1_agent:rdata_fifo_sink_data
	wire          key_1_s1_agent_rdata_fifo_src_ready;                                                // key_1_s1_agent:rdata_fifo_sink_ready -> key_1_s1_agent:rdata_fifo_src_ready
	...
	wire  [104:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> key_1_s1_agent:cp_data
	wire    [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> key_1_s1_agent:cp_channel
	...
	wire  [104:0] sdram_s1_agent_rp_data;                                                             // sdram_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [104:0] key_1_s1_agent_rp_data;                                                             // key_1_s1_agent:rp_data -> router_009:sink_data
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (key_1_s1_agent_rdata_fifo_src_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (key_1_s1_agent_rdata_fifo_src_valid),              //                .valid
		.rdata_fifo_sink_data    (key_1_s1_agent_rdata_fifo_src_data),               //                .data
	...
	mazesolver_soc_mm_interconnect_0_router router (
	...
	mazesolver_soc_mm_interconnect_0_router_001 router_001 (
	...
	mazesolver_soc_mm_interconnect_0_router_002 router_002 (
	...
	mazesolver_soc_mm_interconnect_0_router_002 router_003 (
	...
	mazesolver_soc_mm_interconnect_0_router_002 router_004 (
	...
	mazesolver_soc_mm_interconnect_0_router_002 router_005 (
	...
	mazesolver_soc_mm_interconnect_0_router_002 router_006 (
	...
	mazesolver_soc_mm_interconnect_0_router_007 router_007 (
	...
	mazesolver_soc_mm_interconnect_0_router_007 router_008 (
	...
	mazesolver_soc_mm_interconnect_0_router_007 router_009 (
	...
	mazesolver_soc_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mazesolver_soc_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mazesolver_soc_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mazesolver_soc_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mazesolver_soc_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mazesolver_soc_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mazesolver_soc_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (sdram_pll_c0_clk),                        //       clk.clk
		.reset               (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mazesolver_soc_mm_interconnect_0_cmd_mux_005 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mazesolver_soc_mm_interconnect_0_cmd_mux_005 cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mazesolver_soc_mm_interconnect_0_cmd_mux_005 cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mazesolver_soc_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mazesolver_soc_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mazesolver_soc_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mazesolver_soc_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mazesolver_soc_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (sdram_pll_c0_clk),                        //       clk.clk
		.reset              (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mazesolver_soc_mm_interconnect_0_rsp_demux_005 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mazesolver_soc_mm_interconnect_0_rsp_demux_005 rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mazesolver_soc_mm_interconnect_0_rsp_demux_005 rsp_demux_007 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mazesolver_soc_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mazesolver_soc_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
